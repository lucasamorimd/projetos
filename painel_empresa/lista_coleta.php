...
$colNot = $coleta->pesquisarcoletaNot($id_empresa);
?>
<!DOCTYPE html>
<html lang="en">
  <!--================================================================================
                    ...
                    <table class="responsive-table">
                      ...
                      <tbody>
                        <?php 
                          require_once '../models/DAO/bd_coleta.php';
                          $cole = new bd_coleta;
                          $col = $cole->listarcoletas($id_empresa);
                          $link = '<a href="../controllers/coleta/ctrl_del_coleta.php?id_coleta=<?php echo $c->id_coleta;?>"';
                          foreach ($col as $c) {
                            # code...
                        ...
                        <tr>
                          ...
                          <td><a href='excluir_coleta_confirm.php?id_coleta=<?php echo $c->id_coleta;?>' class="btn-apagar btn-floating btn-large waves-effect waves-light small red"><i class="material-icons">delete_forever</i></a></td>
                          <td><a class="modal-trigger btn-floating btn-large waves-effect waves-light small orange" href="../views/form_altera_coleta.php?id_coleta=<?php echo $c->id_coleta;?>"><i class="material-icons">update</i></a></td>
