        ...
        <nav class="navbar-color gradient-45deg-light-blue-cyan">
          <div class="nav-wrapper">
            ...
            <ul id="profile-dropdown" class="dropdown-content">
              ...
              <li>
                <a href="../controllers/login.php?logou=true" class="grey-text text-darken-1">
                  ...
                  <div class="col s12">
                    <ul id="projects-collection" class="collection z-depth-1">
                      ...
                      <li class="collection-item avatar">
                        ...
                        <h6 class="collection-header m-0">Resíduos</h6>
                        <p>Lista de Residuos cadastrados</p>
                      </li>
                      <?php 
                        require_once '../models/DAO/bd_residuo.php';
                        $resi = new bd_residuo;
                        $res = $resi->pesquisarResiduo($id_empresa);
                        foreach ($res as $re) {
                          # code...
                      ...
                      <li class="collection-item">
                        <div class="row">
                          <div class="col s9">
                            <p class="collections-title"><?php echo $re->tipo; ?></p>
                            <p class="collections-content"><?php echo $re->descricao;?></p>
                          </div>
