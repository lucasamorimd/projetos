        ...
        <div class="col s12 m4 offset-m4">
            <div class="card">
                <div class="card-action indigo darken-3 white-text">
                    <h3 class="center-align">Fazer Cadastro</h3>
                </div>
                <div class="card-content">

                    <form action="<?= $base ?>/controlls/cadastrar_ctrl.php" method="POST">
                        ...
                        <div class="form-field">
                            ...
                            <input type="text" name="apelido" id="apelidoUsuario">
                        </div><br />
                        <div class="form-field">
                            <button class="btn-large indigo darken-3 waves-effect waves-dark" style="width: 100%;">Cadastrar</button>
                        </div><br />
                    </form>
                    <p class="center-align">Já é Cadastrado? <a href="<?= $base ?>/login.php">faça o Login</a></p>
                </div>
            </div>
        </div>
    </div>
