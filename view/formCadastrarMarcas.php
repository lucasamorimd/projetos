  ...
  <body>
        ...
        <section>
            <article>
                <br>
                <div class="row">
                    <form class="col s12" action="../control/controladorMarca.php" method="post">
                        <div class="row">
                            <div class="input-field col s12">
                                <input placeholder="Nome" id="nomemarca" name="nome" type="text" class="validate">
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <input placeholder="tipo produto" id="tipoproduto" name="tipoproduto" type="text" class="validate">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col s12">
                                <button type="submit" class="btn waves-effect waves-light orange darken-1">Cadastrar</button>
                            </div>
                        </div>                       
                    </form>
                </div>               
