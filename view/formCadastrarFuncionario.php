  ...
  <body>
        ...
        <section>
            <article>
                <br>
                <div class="row">
                    <form class="col s12" action="../control/controladorFuncionario.php" method="post">
                        <div class="row">
                          <div class="input-field col s12">
                            ...
                            <div class="input-field col s12">
                                <input id="telefone" name="telefoneFuncionario" type="tel" placeholder="Telefone"  required>
                            
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                              <input id="endereco" placeholder="Endereço" name="enderecoFuncionario" type="text" class="validate" required>
                            
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                              <input id="email" placeholder="Email" name="emailFuncionario" type="email" class="validate" required>
                            
                          </div>
                        </div>                       
                        <div class="row">
                          <div class="input-field col s12">
                              <input id="senha" placeholder="Senha" name="senhaFuncionario" type="password" class="validate" pattern=".{6,}" title="a senha precisa ter 6 ou mais caracteres" required>
                            
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                              <input id="cpf" placeholder="C.P.F" name="cpfFuncionario" type="text" class="validate" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Digite o CPF no formato nnn.nnn.nnn-nn" required>                            
                          </div>
                        </div>
                        <div class="row">
                          <div class="input-field col s12">
                              <input id="cpf" placeholder="Data de Pagamento" name="datapagamentoFuncionario" type="text" class="validate" pattern="\d{1,2}/\d{1,2}/\d{4}" title="Digite a data de contrato no formato dd/mm/aaaa" required>                            
                          </div>
                        </div>                       
                        <div class="row">
                          <div class="input-field col s12">
                              <input id="Pagamento" placeholder="Pagamento" name="pagamentoFuncionario" type="text" class="validate" pattern="^\d{1}.\d{3},\d{2}$" title="Digite o salario no formato 000,00" required>                            
                          </div>
                        </div>
                        <div class="input-field col s12">
                              <input id="Perfil" placeholder="Valor de Perfil" name="perfilFuncionario" type="text" required>                            
                          </div>
                        </div>                       
