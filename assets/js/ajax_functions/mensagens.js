...
function showMessage_to(data) {
    ...
    md.showNotification('top', 'right', data.nome_from + ' Falou: <a class="alert-link" href="' + data.base + '/controlls/chat_ctrl.php?id=' + data.id_chat + '&&nome_to=' + data.nome_from + '">' + data.conteudo + '</a>', 1);
}