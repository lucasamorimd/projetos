    ...
    <tr>
      ...
      <td>
        ...
        <td class="td-actions text-center">
          <a href="cadastraPatrimonio.php?patrimonio=<?php echo $key->id_patrimonio;?>">
        ...
        <td class="td-actions text-center">
          <a href="cadastraTroca.php?patrimonio=<?php echo $key->id_patrimonio;?>">
            <button type="button" rel="tooltip" title="Realizar troca" class="btn btn-danger btn-link btn-sm">
              <i class="material-icons">compare_arrows</i>
            </button></a>
        </td>
        <td class="td-actions text-center">
          <a href="listaTrocas.php?trocasid=<?php echo $key->id_patrimonio;?>">
