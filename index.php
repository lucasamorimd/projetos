...
require dirname(__DIR__) . '/rede_social/partials/header.php';
require dirname(__DIR__) . '/rede_social/partials/sidebar.php';
require dirname(__DIR__) . '/rede_social/partials/navbar.php';
?>
<div class="content">
