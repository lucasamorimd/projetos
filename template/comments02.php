...
$nomebd = new bd_pesquisa_estoque();

$codigo = $_GET['codigo_estoque'];

$nome = $nomebd->pesquisarestoquePorId($codigo);
  ...
  <body>
    ...
    <section class="content">
      ...
      <div class="container">
        ...
        <form class="col s12" action="../controls/entrada/ctrl_entrada.php" method="post">
        
             <div class="row">
               <div class="input-field col s12">
                   <input id="codigo_estoque" name="codigo_estoque" type="text" placeholder="<?php echo $codigo_estoque = $_GET['codigo_estoque']; ?>" value="<?php echo $codigo_estoque; ?>" readOnly/>
             ...
             <div class="row">
               <div class="input-field col s12">
                   <input id="descricao" value="<?php foreach($nome as $n){ echo $n->descricao;} ?>" name="descricao" type="text" readOnly/>
                 
               </div>
             </div>
             <div class="row">
               <div class="input-field col s12">
                   <input id="data" placeholder="Data" name="data" type="date">
                 
               </div>
             </div>
             <div class="row">
               <div class="input-field col s12">
                   <input id="natureza" placeholder="Natureza" name="natureza" type="text">                            
               </div>
             </div>
