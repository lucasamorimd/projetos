...
<html>
  ...
  <body>
    ...
    <section class="content">
      <div class="page-announce valign-wrapper grey darken-4"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign"><i class="medium material-icons"> format_list_bulleted </i> Lista de saidas </h1></div>
          ...
          <table class="responsive-table bordered hoverable highlight">
                      <thead>
                          <tr>
                              ...
                              <th data-field="">Data de saida</th>
                      ...
                      <tbody>
                          ...
                          if(isset($_POST['pesquisa'])){
                              ...
                              $saidas = $saidaDAO->pesquisarsaidaPeloNome($nomesaida);
                          } else {
                              $saidas = $saidaDAO->listarsaidas();
                          }
