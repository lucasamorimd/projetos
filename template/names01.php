...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Meus Cadastros/Estoque</title>
  ...
  <body>
    ...
    <section class="content">
      ...
      <div class="page-announce valign-wrapper grey darken-4"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign"><i class="medium material-icons"> format_list_bulleted </i> Lista de Estoque </h1></div>
      <div class="row">
...
<div class="row">
            <div class="col s12">
            	    ...
            	    <thead>
            	        <tr>
            	            <th data-field="">Codigo de estoque</th>
            	    ...
            	    <tbody>
            	        ...
            	        if(isset($_POST['pesquisa'])){
            	            ...
            	            $estoques = $estoqueDAO->pesquisarestoquePeloNomeId($nomeestoque,$matricula);
            	        } else {
            	            $estoques = $estoqueDAO->pesquisarestoquePorId0($matricula);
            	        }
