...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Meus Cadastros/Saídas</title>
  ...
  <body>
    ...
    <section class="content">
      ...
      <div class="page-announce valign-wrapper grey darken-4"><a href="#" data-activates="slide-out" class="button-collapse valign hide-on-large-only"><i class="material-icons">menu</i></a><h1 class="page-announce-text valign"><i class="medium material-icons"> format_list_bulleted  </i> Lista de saida </h1></div>
      <div class="row">
...
<div class="row">
            <div class="col s12">
            	    ...
            	    <tbody>
            	        ...
            	        require_once '../models/DAO/bd_pesquisa_saida.php';
            	        
            	        $saidaDAO = new bd_pesquisa_saida();
            	        if(isset($_POST['pesquisa'])){
            	            $nomesaida = $_POST['pesquisa'];
            	            $saidas = $saidaDAO->pesquisarsaidaPeloNomeId($nomesaida,$matricula);
            	        } else {
            	            $saidas = $saidaDAO->pesquisarsaidaPorId($matricula);
            	        }
            	        
            	        foreach ($saidas as $produto){
            	        ?>
            	        <tr>
            	            <td><?php echo $produto->codigo_saida; ?></td>
