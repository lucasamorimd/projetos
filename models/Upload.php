...
protected $tipos = array("jpg", "png", "gif"); // Nossos tipos de imagem disponíveis para este exemplo
...
/*
// Se largura é maior que altura, dividimos a largura determinada pela origina e multiplicamos a altura pelo resultado, para manter  proporção da imagem
...
public function salvar($caminho, $file,$matricula){
...
$mensagem = 'Envie apenas imagens no formato jpg, png ou gif!';
return $mensagem;
die();
}
