...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center">
            <h1 class="logo me-auto"><a href="<?= $base ?>#hero">Clinica<span>.</span></a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="index.html" class="logo me-auto"><img src="assets/img/logo.png" alt=""></a>-->

            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="nav-link scrollto" href="<?= $base ?>#hero">Home</a></li>
                    <li><a class="nav-link scrollto" href="<?= $base ?>#about">Sobre</a></li>
                    <li><a class="nav-link scrollto " href="<?= $base ?>#portfolio">Galeria</a></li>
                    <li><a class="nav-link scrollto" href="<?= $base ?>#team">Time de Médicos</a></li>
                    <li class="dropdown"><a><span>Serviços</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="<?= $base ?>#exames">Exames</a></li>
                            <li><a href="<?= $base ?>#consultas">Consultas</a></li>
                            <li><a href="<?= $base ?>#procedimentos">Procedimentos</a></li>
                        </ul>
                    </li>
                    <li><a class="nav-link scrollto" href="<?= $base ?>#contact">Entre em contato</a></li>
                </ul>
