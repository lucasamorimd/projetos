...
<script src="<?= $base ?>/assets/js/bib/autobahn.js"></script>
<script src="<?= $base ?>/assets/socket/teste_copy.js"></script>
<script src="<?= $base ?>/assets/js/ajax_functions/mensagens.js"></script>
...
<script src="<?= $base ?>/assets/js/ajax_functions/notificacoes.js"></script>
</body>
