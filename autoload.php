...
require_once dirname(__DIR__) . '/rede_social/models/Notificacoes.php';
...
require_once dirname(__DIR__) . '/rede_social/models/Notific_mid.php';
...
require_once dirname(__DIR__) . '/rede_social/dao/NotificacaoDaoMysql.php';
