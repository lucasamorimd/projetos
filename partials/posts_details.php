    ...
    <div class="card-body">
        ...
        <div class="card-stats">
            ...
            <div class="stats ml-auto">
                ...
                <a class="btn btn-<?= ($post_details->liked) ? 'danger' : 'default' ?> btn-fab btn-fab-mini btn-round" onclick="event.preventDefault();curtir({base:'<?= $base ?>',id:'<?= $post_details->id_posts ?>',id_usuario:'<?= $post_details->id_usuario ?>'})" id="like<?= $post_details->id_posts ?>" data-toggle="tooltip" data-placement="top" href="#">
