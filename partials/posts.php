            ...
            <div class="card-body">
                ...
                <div class="card-stats">
                    ...
                    <div class="stats ml-auto">
                        <a class="btn btn-<?= ($item->liked) ? 'danger' : 'default' ?> btn-fab btn-fab-mini btn-round" onclick="event.preventDefault();curtir({base:'<?= $base ?>',id:'<?= $item->id_posts ?>',id_usuario:'<?= $item->id_usuario ?>'})" id="like<?= $item->id_posts ?>" data-toggle="tooltip" data-placement="top" title="<?= ($item->liked) ? 'Descurtir' : 'Curtir' ?>" href="#">
