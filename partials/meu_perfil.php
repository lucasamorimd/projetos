<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="perfil_ctrl.php" enctype="multipart/form-data" method="POST">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            ...
                            <div class="card-header card-header-primary">
                                ...
                                <img class="card-img-top" src="<?= $base ?>/media/avatar/<?= $userInfo->avatar ?>" rel="nofollow" alt="Card image cap">
                                <div class="card-body">
