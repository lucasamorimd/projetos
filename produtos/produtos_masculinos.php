...
<!--fim do modal-->          
	...
	<!--<br>-->
                    <div class="banner">
                        <a href="../index.php"><img src="../bnr_M.png" style="width: 100%;height:20%; heightcursor:pointer"></a>
                    </div>
		<section>
                    <div clas="container">
                        ...
                        <div class="row">
                            <div class="ctr">
                                ...
                                <div class="painel">
                                    ...
                                    $_SESSION['masculino'] = count($produtos);
                                    ?>
                                    <div class="collection ">
                                        <a href="#!" class="collection-item active grey darken-4"><span class="white-text badge orange"><?php echo $_SESSION['masculino']; ?></span> Masculino</a>
                                        <a href="produtos_feminino.php" class="collection-item black-text "><span class="white-text badge red"><?php echo $_SESSION['feminino']; ?></span> Feminino</a>
                                         ...
                                         ?>
                                            <div class="col s12 m4 ">			    
                                                <div class="card produto">
                                                    ...
                                                    <?php } else { ?>
                                                    <button class="btn detproduto red darken-4 btnss3" type="button">Indisponível</button>
                                                    <?php } ?>  
