...
<!--fim do modal-->          
	...
	<!--<br>-->
                    <div class="banner">
                        <a href="../index.php"><img src="../bnr.png" style="width: 100%;height:20%; heightcursor:pointer"></a>
                    </div>
		<section>
                    <div clas="container">
                            ...
                            <div class="ctr">
                                ...
                                <div class="painel">
                                    <div class="collection ">
                                        ...
                                        <a href="" class="collection-item active grey darken-4"><span class="white-text badge orange"><?php echo $_SESSION['todos']; ?></span> todos</a>
