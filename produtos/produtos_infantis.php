...
<hr color='#e8eaf6'> <!--indigo lighten-5-->    
    ...
    <div class="carousel-fixed-item center">
        <input value="acessar" type="submit" class="validate">
    </div>     
  </div>
</div>
<!--fim do modal-->          
	...
	<!--<br>-->
                    <div class="banner">
                        <a href="../index.php"><img src="../bnr_C.png" style="width: 100%;height:20%; heightcursor:pointer"></a>
                    </div>
		<section>
                    <div clas="container">
                        ...
                        <div class="row">
                            <div class="ctr">
                                ...
                                <div class="painel">
                                    ...
                                    $_SESSION['infantil'] = count($produtos);
                                    ?>
                                    <div class="collection ">
                                        ...
                                        <a href="#" class="collection-item grey darken-4 active"><span class="white-text badge orange"><?php echo $_SESSION['infantil']; ?></span> Infantil</a>
