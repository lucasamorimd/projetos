...
$funcionario = $novoFuncionarioDAO->listarfuncionarios();
...
<table class="responsive-table">
    ...
    <tr>
        ...
        <td><?php echo "<a class='btn btn-info white-text  blue darken-1' href='../view/formAlterarFuncionario.php?idfuncionario=".$c->idfuncionario 
                . "' onclick='return checkDelete()'><i class='material-icons '>mode_edit</i> ";?></td>
        <td><?php echo "<a class='btn btn-danger white-text  red darken-4' href='controladorExcluiFuncionario.php?idfuncionario="
        . $c->idfuncionario . "' onclick='return checkDelete()'><i class='material-icons '>delete</i> </a>";?></td>
